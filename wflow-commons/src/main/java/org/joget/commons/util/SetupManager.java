...
public class SetupManager {
    ...
    public static String getBaseDirectory() {
        if (HostManager.isVirtualHostEnabled()) {
            ...
            String baseDirectory = BASE_DIRECTORY + File.separator + DIRECTORY_PROFILES + File.separator + currentProfile + File.separator;            LogUtil.info(SetupManager.class.getName(), "Virtual host support enabled");
