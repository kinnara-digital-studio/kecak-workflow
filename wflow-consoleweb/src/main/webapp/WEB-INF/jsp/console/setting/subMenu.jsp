...
<li id="nav-setting-oauth2plugin"><a class="nav-link" href="${pageContext.request.contextPath}/web/console/setting/oauth2plugin"><span class="nav-steps">&nbsp;</span><fmt:message key="console.header.submenu.label.setting.oauth2plugin"/></a></li>
