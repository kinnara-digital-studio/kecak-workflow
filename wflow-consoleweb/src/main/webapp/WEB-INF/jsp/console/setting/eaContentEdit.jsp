        ...
        <form:form id="createEAContent" action="${pageContext.request.contextPath}/web/console/setting/eaContent/submit/edit" method="POST" commandName="eaContent" cssClass="form">
            ...
            <fieldset>
                ...
                <div class="form-row">
                    ...
                    <span class="form-input"><c:out value="${eaContent.id}"/><input id="id" type="hidden" value="${eaContent.id}" name="id"/></span>
                </div>
                <div class="form-row">
                    <label for="field1"><fmt:message key="console.setting.eaContent.common.label.processId"/></label>
                    <span class="form-input"><c:out value="${eaContent.processId}"/><input id="processId" type="hidden" value="${eaContent.processId}" name="processId"/></span>
                </div>
                <div class="form-row">
                    <label for="field1"><fmt:message key="console.setting.eaContent.common.label.activityId"/></label>
                    <span class="form-input"><c:out value="${eaContent.activityId}"/><input id="activityId" type="hidden" value="${eaContent.activityId}" name="activityId"/></span>
                </div>
                <div class="form-row">
