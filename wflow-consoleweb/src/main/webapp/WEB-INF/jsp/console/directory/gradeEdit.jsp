...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createGrade" action="${pageContext.request.contextPath}/web/console/directory/grade/submit/edit?orgId=${encodedOrgId}" method="POST" commandName="grade" cssClass="form">
