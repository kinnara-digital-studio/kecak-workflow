...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createDept" action="${pageContext.request.contextPath}/web/console/directory/dept/submit/edit?orgId=${encodedOrgId}&parentId=${parent.id}" method="POST" commandName="department" cssClass="form">
